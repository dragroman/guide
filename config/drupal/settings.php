<?php
file_put_contents('/tmp/getenv_debug.log', print_r(getenv(), true));
file_put_contents('/tmp/env_debug.log', print_r($_ENV, true));
file_put_contents('/tmp/server_debug.log', print_r($_SERVER, true));
// phpcs:ignoreFile
 ...
 * @endcode
 */
$settings['hash_salt'] = 'n_6GZTLss3D-V4xSaZNI_wAZAhMYvNB_Ra4DVtxda9Edni4m2OmDCy3rukrGHkEF5lzUZgo1OQ';
