...
export const texts = {
  ...
  budget: {
    ...
    description:
      "Мы хотим создать путешествие именно под вас! Дайте нам ориентир по бюджету, и мы подберём тур вашей мечты.",
    visaQuestion: "Требуются ли услуги оформления виз?",
    insuranceQuestion: "Страховка нужна?",
    label: "Выберите сколько планируете тратить в день, включая проживание",
